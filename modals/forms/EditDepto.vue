...
export default defineComponent({
  ...
  setup(props) {
    ...
    const adddepartamentoRef = ref<null | HTMLElement>(null);
    ...
    onMounted(async () => {
      await apiApp.get("/departamentos/"+ props.id).then((res) => {
        departamento.value = res.data
        cardData.value = {
    ...
    const submit = () => {
      ...
      apiApp.put("/departamentos/"+ props.id, values).then((res) => {
        console.log(res);
        Swal.fire({
          text: "Se ha editado el departamento exitosamente",
          icon: "success",
          ...
          props.refresh();
          hideModal(adddepartamentoRef.value);
        });
      });
    };
