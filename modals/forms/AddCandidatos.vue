<template>
  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      const Candidatoss = ref<Candidatos[]>([]);
  
      const cardData = ref<Candidatos>({
        Nombre: "",
        Direccion: "",
        Telefono: "",
        Email: "",
      ...
      onMounted(async () => {
        await apiApp.get("/Candidatoss").then((res) => {
          Candidatoss.value = res.data;
        });
      });
      ...
      const submit = () => {
        ...
        const values = {
          ...
          Direccion: cardData.value.Direccion,
          Telefono: cardData.value.Telefono,
          Email: cardData.value.Email,
        };
  
        apiApp.post("/Candidatoss", values).then((res) => {
          console.log(res);
          Swal.fire({
            text: "Se ha creado el Candidatos exitosamente",
            icon: "success",
